...
// This exercises TwoEC on a SymbolGraph (some input file).
...
public class Driver
{
    ...
    // in case you want to invoke these from within BlueJ.
    ...
    public static void run(String fileName, String sep)
    {
        ...
        if (countSize1 > 0)
            System.out.println("Also saw " + countSize1 + " 2EC components of size one");
        if (sumSizes != V)
